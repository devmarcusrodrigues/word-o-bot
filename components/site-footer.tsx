    ...
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <div className="w-full max-w-screen-xl mx-auto px-4 md:px-6 py-12 text-left">
        <div className="grid gap-8 lg:grid-cols-4 md:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              {[
                ...
                { name: "Contato", href: "https://www.instagram.com/theinfinityworks/" },
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Contato (Instagram):</h3>
        ...
        <div className="border-t border-slate-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-400 text-sm">© 2025 Palavrobô. Todos os direitos reservados.</p>

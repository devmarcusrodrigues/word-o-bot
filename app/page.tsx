              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="flex flex-col gap-3 min-[400px]:flex-row">
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-2 hover:bg-slate-50 transition-all duration-300 bg-transparent"
                  >
                ...
                <div className="flex items-center gap-6 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-slate-600 font-medium">+1.200 famílias</span>
                  </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] items-center">
              <div className="flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  ...
                  <p className="max-w-[600px] text-slate-600 text-lg leading-relaxed">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start space-x-4 p-4 rounded-xl bg-white shadow-sm border border-slate-100"
                    >
